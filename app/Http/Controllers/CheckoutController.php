...
class CheckoutController extends Controller
{
    ...
    {
        // Inserting data to transaction table
    ...
    public function remove(Request $request, $detail_id)
    {
        ...
        // calculating the travel price - any additional price that user removes
    ...
    public function create(Request $request, $id)
    {
        ...
        // if user adding a visa
        if ($request->is_visa) {
            $transaction->transaction_total += 190;
            $transaction->additional_visa += 190;
        }

        // calculating the travel price + any additional price that user added
        $transaction->transaction_total += $transaction->travel_package->price;
    ...
    public function success(Request $request, $id)
    {
        ...
        // send email after transaction is successfuly done
