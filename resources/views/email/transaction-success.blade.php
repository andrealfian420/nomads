                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;">
                                                            <img alt="Travel Destination" height="auto"
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #fff;vertical-align:middle;padding-bottom:30px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="" width="100%">
                                                    <tr>
                                                        <td align="left"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#FF9E53"
                                                                        ...
                                                                        <a href="{{url('checkout/'.$data->id)}}"
                                                                            style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:semibold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                            Check Details </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr>
                                                    <td style="width:50px;">
                                                        <img src="{{url('frontend/images/support@2x.png')}}"
                                                            width="50px" alt="support_icon" />
                                                    </td>
                                                    <td
