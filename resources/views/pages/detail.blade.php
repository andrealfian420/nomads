                        ...
                        <div class="gallery">
                            <div class="xzoom-container">
                                ...
                                <div class="xzoom-thumbs">
                                    <a href="{{url('frontend/images/details-1.jpg')}}"><img class="xzoom-gallery"
                                            width="128" src="{{url('frontend/images/details-1.jpg')}}"
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="{{url('frontend/images/member-1.png')}}" alt="Members" class="member-image mr-1">
                            <img src="{{url('frontend/images/member-2.png')}}" alt="Members" class="member-image mr-1">
                            <img src="{{url('frontend/images/member-3.png')}}" alt="Members" class="member-image mr-1">
                            <img src="{{url('frontend/images/member-4.png')}}" alt="Members" class="member-image mr-1">
                            <img src="{{url('frontend/images/member-5.png')}}" alt="Members" class="member-image mr-1">
                        </div>
                        <hr>
                    ...
                    <div class="join-container">
                        <a href="{{route('checkout')}}" class="btn btn-block btn-join-now mt-3 py-">
                            Join Now
                        </a>
                    </div>
